...
let timeoutClosure = { (endpoint: Endpoint, closure: MoyaProvider<UUApi>.RequestResultClosure) -> Void in
...
//MARK: 无loading请求
let ApiProvider = MoyaProvider<UUApi>(requestClosure: timeoutClosure)
//MARK: 有loading请求
let ApiLoadingProvider = MoyaProvider<UUApi>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
